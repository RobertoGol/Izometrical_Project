...
namespace bunker
{
    ...
    class Camera
    {
      ...
      public:
        Camera()
        {
            m_View.setSize({static_cast<float>(Config::SCREEN_WIDTH), static_cast<float>(Config::SCREEN_HEIGHT)});
        }
        ...
        {
            m_Zoom = z;
            m_View.setSize({Config::SCREEN_WIDTH * m_Zoom, Config::SCREEN_HEIGHT * m_Zoom});
        }
