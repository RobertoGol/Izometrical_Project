...
namespace bunker
{
    ...
    class HUD
    {
      private:
        ...
        void drawBar(sf::RenderWindow& window, float x, float y, float width, float height, float percent,
                     sf::Color bgColor, sf::Color fillColor, sf::Color borderColor = sf::Color::Transparent);

        void drawText(sf::RenderWindow& window, const std::string& str, float x, float y, int size,
                      sf::Color color = sf::Color::White);

        void drawTankFrame(sf::RenderWindow& window, float W, float H);

        void renderScoutHUD(sf::RenderWindow& window, const GameState& gs, const PlayerController& ctrl,
                            const TacticsManager& tactics, const PlayerInventory& inventory, float W, float H);

        void renderTankHUD(sf::RenderWindow& window, const GameState& gs, const TitanAI& titanAI, float W, float H);

        void renderVehicleHUD(sf::RenderWindow& window, const GameState& gs, const VehicleManager& vehicles, float W,
                              float H);
      ...
      public:
        ...
        void render(sf::RenderWindow& window, const GameState& gs, const PlayerController& playerCtrl,
