...
void PlayerController::update(GameState& gs, const InputSnapshot& input, float dt) {
    ...
    targetDir.x = s_LastCamForward.x * input.moveForward
                + s_LastCamRight.x   * input.moveStrafe;
    targetDir.y = s_LastCamForward.y * input.moveForward
                + s_LastCamRight.y   * input.moveStrafe;
    ...
    // ══════════════════════════════════════════════════════════
    bool canSprint = (m_CurrentStamina > 0.0f)
                   && isMoving
