...
then reintroducing mechanics in dependency order,
then connecting them through shared systems,
then polishing balance and content,
then removing dead legacy code.
The result must be:
...
HumanTactical
RobotControl
Awareness / aggro logic

delayed detection
awareness buildup
attack state transition
Mechanical hostile localized damage
...
Stress system
SecondWind system
SoulLine last-chance system
Heal action
Reload action
Rations with temporary buffs
C. Titan / Vehicle / Heavy System
Bucket Rig
Ram Shield
Tow Coupler
Seat swapping
Tank thermal load / overheating
cockpit-based fire logic
mount / dismount flow
titan internal state management improvements
D. World / Interaction
Weather system
EtherFog
AcidRain
Radio / Tape system
Terminal sync / pip-pad sync
Hangar system
Reactive breakables
Zone events / scripted progression
E. Progression / Systems
Skill system
Loot generator by tiers
Profile / session management
Story route progression
F. Tooling / Meta
World editor features
prefab library
G. Optional / likely redesign-required
Lanline services / multiplayer-adjacent features
5.2 From Video_Game_Izom
A. Build / Utility
C.A.M.P.-style building system

walls
turrets
boxes / utility placement
ToolGun / live editor interaction

B. Runtime / Performance
SpatialGrid optimization for collisions and lookups
C. Asset / Rendering
OBJ model loading support
D. Networking
Winsock multiplayer support up to ~20 players
