...
Использовать /, а не \.
Не писать пути с разным регистром в разных местах.
Не собирать пути вручную во многих gameplay-файлах.
По возможности использовать централизованный resolver/helper.
Не хранить “магические строки” ассетов внутри AI/combat/story логики.
Плохо
C++
